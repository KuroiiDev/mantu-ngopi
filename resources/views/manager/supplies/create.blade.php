...
@section('title', 'Tambah Bahan Baku - Mantu-Ngopi')

@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-xl font-bold text-white">Tambah Bahan Baku</h1>
    ...
    <div class="bg-gray-800 rounded-xl border border-gray-700 p-6 max-w-lg mx-auto">
        <form action="{{ route('manager.supplies.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-1.5">Stok Awal</label>
