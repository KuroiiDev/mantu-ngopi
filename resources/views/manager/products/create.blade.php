...
@section('title', 'Tambah Menu - Mantu-Ngopi')

@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-xl font-bold text-white">Tambah Menu</h1>
    ...
    <form action="{{ route('manager.products.store') }}" method="POST" enctype="multipart/form-data" x-data="{
        ...
        <div class="max-w-2xl mx-auto space-y-4">
            ...
            <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                ...
                <div x-data="{ preview: null }">
                    ...
                    <p class="text-xs text-gray-500 mt-2">Format: JPG, PNG, max 2MB. Opsional.</p>
                </div>
            </div>
